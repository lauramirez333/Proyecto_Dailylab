        ...
        <div class="signin-signup">
          ...
          <form action="?c=usuario&a=savePac" id="registro" method="post" onsubmit="verificarPasswords();">
            ...
            <div class="input-field">
              ...
              <input name="Nombres_Usuario" type="text" maxlength="25" oninput="maxlengthNumber(this);" required />
            </div>
            ...
            <div class="input-field">
              <i class="fas fa-user"></i>
              <input name="Apellidos_Usuario" type="text" maxlength="25" oninput="maxlengthNumber(this);" required />
            </div>

            <label class="guia" for="">Documento</label>
            <div class="input-field">
              <i class="fas fa-id-card-alt"></i>
              <input name="Documento_Identificacion" type="number" maxlength="10" oninput="maxlengthNumber(this);" required />
            </div>
            ...
            <div class="input-field">
              ...
              <input name="Correo_Electronico" type="email" maxlength="40" oninput="maxlengthNumber(this);" required />
            </div>

            <label class="guia" for="">Confirma tu correo</label>
            <div class="input-field">
              <i class="fas fa-envelope"></i>
              <input name="Correo_Electronico2" type="email" maxlength="40" oninput="maxlengthNumber(this);" required />
            </div>

            <label class="guia" for="">Telefono</label>
            <div class="input-field">
              <i class="fas fa-phone-alt"></i>
              <input name="Telefono_Usuario" type="number" maxlength="10" oninput="maxlengthNumber(this);" required />
            </div>
