...
const expresiones = {
	...
	Documento: /^\d{7,10}$/ // 7 a 14 numeros.
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && campos.Documento && terminos.checked ){
		formulario.reset();
